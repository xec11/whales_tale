...
First appearance, though not yet named. During the Iran strike, even after setting clear boundaries on the team call (available if needed, not proactively working), the pull to keep checking the market didn't stop. The rational decision was made, but the feeling of "I should be doing more" persisted underneath.

## 2026-03-03

Named and sharpened during a firefighting week experienced from vacation. Greg offered the chance to work remotely; the team picked the lightest option (stay on vacation, be reachable). Rationally fine. But the guilt didn't go away.

**The core pattern:** In high-stakes roles, there's no natural stopping point. You can always do more, worry more, prepare more. The effort ceiling is infinite and you're always below it. This isn't about performing commitment for others (that's performative sense of duty) — it's an internal sense that you haven't done enough, even when you logically know you have.

- In a crisis, "there's always something more." The guilt is self-generated, not just socially imposed.
- This is what makes the Michael & Suyash startup idea suspect — startups have the same unboundedness, probably worse.
- Open question: would clear, enforced boundaries make this tolerable? Or does the feeling persist regardless of the boundary?

**Strategy vs. reflex:** A coaching text Shirley shared described how "pushing hard shifts from strategy to reflex" — pressure pairs with achievement so many times that the drive to overinvest becomes automatic, not chosen. The brain stays in "stay on" even when pressure eases.
